...
class LDAPUserSearch(UserSearch):
    ...
    def __init__(self, user_search_string, search_by):
        ...
        self.LDAP_SERVER_URI = import_from_settings('LDAP_MODIFY_SERVER_URI')
        self.LDAP_USER_SEARCH_BASE = import_from_settings('LDAP_MODIFY_BASE')
        self.LDAP_BIND_DN = import_from_settings('LDAP_MODIFY_BIND_DN', None)
        self.LDAP_BIND_PASSWORD = import_from_settings('LDAP_MODIFY_BIND_PASSWORD', None)
        self.LDAP_CONNECT_TIMEOUT = import_from_settings('LDAP_MODIFY_CONNECT_TIMEOUT', 2.5)
        self.LDAP_USE_SSL = import_from_settings('LDAP_MODIFY_USE_SSL', True)
